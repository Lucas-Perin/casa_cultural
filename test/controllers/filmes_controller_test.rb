...
class FilmesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create filme" do
    assert_difference("Filme.count") do
      post filmes_url, params: { filme: { ano_lancamento: @filme.ano_lancamento, genero: @filme.genero, sinopse: @filme.sinopse, titulo: @filme.titulo } }
    end
  ...
  test "should update filme" do
    patch filme_url(@filme), params: { filme: { ano_lancamento: @filme.ano_lancamento, genero: @filme.genero, sinopse: @filme.sinopse, titulo: @filme.titulo } }
