...
class AnalisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create analise" do
    assert_difference("Analise.count") do
      post analises_url, params: { analise: { analise: @analise.analise, filme_id: @analise.filme_id, nota: @analise.nota } }
    end
  ...
  test "should update analise" do
    patch analise_url(@analise), params: { analise: { analise: @analise.analise, filme_id: @analise.filme_id, nota: @analise.nota } }
